...
#[derive(Debug)]
pub struct FortiLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FortiLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FortiLink processing");
    
    let mut processor = FortiLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FortiLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FortiLinkProcessor::new(false);
